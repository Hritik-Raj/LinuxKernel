...
void enter(void); // Added to handle the enter key
void putc_key(uint8_t c, int curr_idx); // Added to print char to screen
void update_cursor(int row, int col); // Added to update cursor
void new_line(); // Added a new line for term write
void handle_ctrl_l(); //Added to clear the screen
void scroll(); // Added to check if scrolling is needed
void handle_backspace(); // Added to handle a backspace char
